...
import { useTransactionDetailPage } from '~/composables/transactions/useTransactionDetailPage'
...
<template>
  ...
  >
    ...
    <div v-if="pageError" class="detail-alert" role="alert">
      ...
      <button type="button" @click="loadTransaction">Retry</button>
    </div>

    <div v-if="showInitialLoading" class="detail-loading-layout">
      <section
        class="detail-card detail-skeleton-card detail-skeleton-card--hero"
      >
        <span />
        <small />
        <small />
      ...
      <section
        class="detail-card detail-skeleton-card detail-skeleton-card--wide"
      >
        <span />
        <small />
        <small />
          ...
          <dl>
            ...
            <div>
              ...
              <dd>
                ...
                <span>{{
                  getAgentDisplayEmail(transaction.listingAgentId)
                }}</span>
              </dd>
            </div>
            ...
            <div>
              ...
              <dd>
                ...
                <span>{{
                  getAgentDisplayEmail(transaction.sellingAgentId)
                }}</span>
              </dd>
            </div>
        ...
        <section class="detail-card timeline-card">
          ...
          <ol v-if="stageHistory.length > 0" class="stage-timeline">
            <li
              ...
              :class="{
                'stage-timeline__item--last': index === stageHistory.length - 1,
              }"
            >
